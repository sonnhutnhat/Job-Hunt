                            ...
                            <div class="row custom-tab">
                                <div class="col-lg-3 col-md-12">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <a class="nav-link active text-center border mb-2 rounded-pill" id="v-pills-1-tab"
                                            data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1"
                                            aria-selected="true">Login Page</a>
                                        <a class="nav-link text-center border mb-2 rounded-pill" id="v-pills-2-tab"
                                            data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2"
                                            aria-selected="false">Signup Page</a>
                                        <a class="nav-link text-center border mb-2 rounded-pill" id="v-pills-3-tab"
                                            data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3"
                                            aria-selected="false">Forget Password Page</a>
                                        <a class="nav-link text-center border mb-2 rounded-pill" id="v-pills-4-tab"
                                            data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4"
                                            aria-selected="false">Job Listing Page</a>
                                        <a class="nav-link text-center border mb-2 rounded-pill" id="v-pills-5-tab"
                                            data-toggle="pill" href="#v-pills-5" role="tab" aria-controls="v-pills-5"
                                            aria-selected="false">Company Listing Page</a>
                                    </div>
                                </div>
